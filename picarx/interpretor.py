...
class Interpretor(object):
    ...
    def grayscale_processing(self):
        ...
        # return(self.gs_rel_position, self.state)

    ####### CAMERA ########
    def camera_processing(self):
        """Operates on self.camera_val, a lane line generated by the camera"""
        # average the x positions of the line? take x1? find an x value
        # map that value to a steering angle based on how far from center it is
        # need frame shape
